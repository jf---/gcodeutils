...
cdef class GLine:
    ...
    cdef float _current_x, _current_y, _current_z, _current_e, _current_f
    ...
    property current_e:
        ...
        def __set__(self, value):
            ...
            self._status = set_has_var(self._status, pos_current_e)
    property f:
        def __get__(self):
            if has_var(self._status, pos_f):
                return self._f
            else:
                return None
        def __set__(self, value):
    ...
    property current_f:
        def __get__(self):
            if has_var(self._status, pos_f):
                ...
                return None
        def __set__(self, value):
            self._current_f = value
            self._status = set_has_var(self._status, pos_current_f)
    property i:
        def __get__(self):
            if has_var(self._status, pos_i):
                return self._i
            else:
                return None
        def __set__(self, value):
    ...
    property relative:
        def __get__(self):
            if has_var(self._status, pos_relative):
                return True
            else:
                return False
        def __set__(self, value):
            if value:
                ...
                self._status = unset_has_var(self._status, pos_relative)
    property relative_e:
        def __get__(self):
            if has_var(self._status, pos_relative_e):
                return True
            else:
                return False
        def __set__(self, value):
            if value:
                ...
                self._status = unset_has_var(self._status, pos_relative_e)
    property extruding:
        def __get__(self):
            if has_var(self._status, pos_extruding):
                return True
            else:
                return False
        def __set__(self, value):
            if value:
                ...
                self._status = unset_has_var(self._status, pos_extruding)
    property current_x:
        def __get__(self):
            if has_var(self._status, pos_current_x):
    ...
    property current_y:
        def __get__(self):
            if has_var(self._status, pos_current_y):
    ...
    property current_z:
        def __get__(self):
            if has_var(self._status, pos_current_z):
    ...
    property current_tool:
        def __get__(self):
            if has_var(self._status, pos_current_tool):
                return self._status >> 24
            else:
                return None
        def __set__(self, value):
    ...
    property gcview_end_vertex:
        def __get__(self):
            if has_var(self._status, pos_gcview_end_vertex):
                return self._gcview_end_vertex
            else:
                return None
        def __set__(self, value):
